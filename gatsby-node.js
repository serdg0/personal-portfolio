    ...
    const projects = [
        {
            ...
            build: ['Javascript', 'Ruby', 'npm', 'React', 'Redux', 'Ruby on Rails', 'Heroku', 'Netlify'],
        ...
        {
            name: 'Bookstore CMS',
            url: 'https://bookstore-react-reduxjs.netlify.com',
            repo: 'https://github.com/serdg0/bookstore',
            build: ['Javascript', 'npm', 'React', 'Redux', 'Netlify'],
        ...
        {
            name: 'Calculator',
            url: 'https://simple-calculator-reactjs.netlify.com',
            repo: 'https://github.com/serdg0/React-Calculator',
            build: ['Javascript', 'npm', 'React', 'Netlify'],
